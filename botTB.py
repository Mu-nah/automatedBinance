...
def check_signal():
    ...
    if last_tp_hit_time and datetime.utcnow() - last_tp_hit_time < timedelta(minutes=30): return None
...
def place_order(order_type):
    ...
    # ✅ TP Logic: 100 pips above/below BB_mid for reversal, BB_high/low for trend
